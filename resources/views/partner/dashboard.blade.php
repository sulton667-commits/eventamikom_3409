    ...
    <header class="bg-header text-white shadow-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex flex-wrap justify-between items-center gap-4">
            ...
            <div class="flex items-center gap-2.5">
                <!-- Scanner Button -->
                <button onclick="openScannerModal()" class="bg-white hover:bg-slate-100 text-slate-800 font-bold px-4 py-2 rounded-full text-xs flex items-center gap-2 shadow-sm transition active:scale-95 cursor-pointer">
