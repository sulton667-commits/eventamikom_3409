...
<body class="bg-slate-50 text-slate-900 flex min-h-screen">
    ...
    sticky top-0 h-screen">
        ...
        <div class="pt-6 border-t border-indigo-800 space-y-1">
            <a href="{{ url('/') }}" class="w-full flex items-center gap-3 px-4 py-3 text-indigo-300 hover:text-white transition font-medium text-left rounded-xl">
            ...
            <form method="POST" action="{{ route('admin.logout') }}">
                @csrf
                <button type="submit" class="w-full flex items-center gap-3 px-4 py-3 text-indigo-300 hover:text-white transition font-medium text-left rounded-xl">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
